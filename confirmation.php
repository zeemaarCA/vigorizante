          ...
          <div class="row">
            ...
            <div class="content-box">
              ...
              <div class="row align-items-center">
                ...
                <div class="col-lg-8">
                  <p>ups</p>
                  <p>IF YOU ORDER NOW, THE EARLIEST DELIVERY DATE SHALL BE ON 10/4/2018. INFORMATION:</p>
                  <p>SMS MESSAGES WILL BE SENT TO THE NUMBER: +971-0561458489</p>
                </div>
              </div>
            </div>
            <div class="content-box">
              ...
              <div class="row align-items-center">
                <div class="col-lg-4">
                  <img src="assets/img/checkoutb5.png" alt="">
                </div>
                <div class="col-lg-8">
                  <p class="mb-0">visa master card</p>
                </div>
              </div>
            </div>
